...
void wax_start(char* initScript, lua_CFunction extensionFunciton, ...) {
	...
	// ---------------
		...
		char wax_stdlib[] = WAX_STDLIB;
	#else
		char wax_stdlib[] = "require 'wax'";
	#endif

	if (luaL_loadbuffer(L, wax_stdlib, sizeof(wax_stdlib) - 1, "loading wax stdlib") || lua_pcall(L, 0, LUA_MULTRET, 0)) {
